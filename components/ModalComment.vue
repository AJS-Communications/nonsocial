  ...
  <div>
    ...
    <Teleport to="body">
      <UseFocusTrap v-if="open" :options="{ immediate: true }">
        ...
        >
          <div class="relative flex flex-col-reverse gap-4 mx-auto max-w-screen-sm mt-12 p-4 rounded-xl bg-white dark:bg-black shadow-md shadow-neutral-500 dark:shadow-neutral-900">
            <div
